...
export const API_ROUTE_DEFINITIONS: RouteDefinition[] = [
    ...
    // Dashboard
    {
        ...
        parameters: [
            ...
            query("scope", "ขอบเขตช่องทางที่ใช้กับ KPI และ Analytics", { type: "string", enum: ["all", "line", "marketplaces"], default: "all" }, false, "all"),
        ],
    ...
    },
    {
        ...
        parameters: [
            ...
            query("payment_state", "กรองความหมายสถานะชำระเงินที่ UI ใช้จริง", { type: "string", enum: ["unpaid", "payment_review", "paid", "overdue"] }),
    ...
    {
        path: "/orders/{orderId}/amount",
        method: "post",
        tag: "Orders",
        summary: "แก้ยอดเงิน Order ภายใน CRM",
        description: "Admin/Manager แก้ได้เฉพาะ LINE Order ที่ยัง Active, ยังไม่ชำระและไม่มีสลิปรอตรวจ พร้อม optimistic concurrency, idempotency และ Activity audit",
        security: "cookie",
        parameters: [
            pathParameter("orderId", "Lark Order record_id", "recxxxxxxxx"),
            header("Idempotency-Key", "คีย์ป้องกันการบันทึกซ้ำ ความยาว 8-120 ตัวอักษร", false),
        ],
        requestSchema: "OrderAmountUpdateRequest",
        requestExample: {
            total_amount: "1250.50",
            expected_updated_at: "2026-06-30T08:00:00.000Z",
            idempotency_key: "order-amount:recxxxxxxxx:request-001",
            reason: "ปรับยอดตามที่ตกลงกับลูกค้า",
        },
        responseSchema: "OrderAmountUpdateResponse",
    },
    // Production & Stock Control
    {
        path: "/pc/overview",
        method: "get",
        tag: "Production & Stock",
        summary: "ภาพรวมสินค้าคงคลัง วัตถุดิบ และแผนผลิต",
        description: "อ่านข้อมูลจาก PC_Products, PC_Materials และ PC_Production ใน Lark Base เดิม พร้อม KPI สำหรับ Dashboard",
        security: "cookie",
        responseSchema: "PcOverviewResponse",
    },
    {
        path: "/pc/orders/{orderId}/reconcile",
        method: "post",
        tag: "Production & Stock",
        summary: "ส่ง Order หนึ่งรายการเข้าคิวปรับสต็อก",
        description: "Admin/Manager สั่ง Reconcile Order แบบ idempotent ระบบจะตัดหรือคืน Finished Goods ตามสถานะชำระเงินจริง",
        security: "cookie",
        parameters: [
            pathParameter("orderId", "Lark Order record_id", "recxxxxxxxx"),
            header("Idempotency-Key", "คีย์เหตุการณ์สำหรับติดตามคำขอซ้ำ", false),
        ],
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    },
    {
        path: "/pc/reconcile/orders",
        method: "post",
        tag: "Production & Stock",
        summary: "ส่ง Orders ที่เลือกเข้าคิว Reconcile",
        description: "ต้องระบุ record_id จำนวน 1-100 รายการและยืนยันอย่างชัดเจน ระบบไม่รองรับการส่ง Order ย้อนหลังทั้งหมดโดยอัตโนมัติเพื่อป้องกันตัดสต็อกเก่าโดยไม่ตั้งใจ",
        security: "cookie",
        requestSchema: "PcOrderBulkReconcileRequest",
        requestExample: {
            confirm_selected_orders: true,
            order_record_ids: ["recxxxxxxxx"],
        },
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    },
    {
        path: "/pc/materials/refresh",
        method: "post",
        tag: "Production & Stock",
        summary: "คำนวณแผนใช้วัตถุดิบใหม่",
        description: "รวมความต้องการจาก Production batch ที่ยังเปิด คำนวณ projected stock, shortage และสถานะ Block",
        security: "cookie",
        parameters: [header("Idempotency-Key", "คีย์เหตุการณ์สำหรับติดตามคำขอซ้ำ", false)],
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    },
    {
        ...
        method: "post",
        tag: "Production & Stock",
        summary: "สร้าง Production batch แบบ Manual",
        description: "Admin/Manager สร้างแผนผลิตจาก SKU ที่มีอยู่ใน PC_Products โดยยังไม่หักวัตถุดิบ",
        security: "cookie",
        requestSchema: "PcProductionCreateRequest",
        requestExample: {
            product_sku: "BNK-LUNA-IV-M",
            planned_qty: 20,
            owner: "Production Team",
            notes: "ผลิตสำหรับหน้าร้าน",
        },
        responseSchema: "PcProductionRecord",
        successStatus: 201,
    },
    {
        path: "/pc/production/{productionId}/approve",
        method: "post",
        tag: "Production & Stock",
        summary: "อนุมัติ Production batch",
        description: "ตรวจ BOM และวัตถุดิบจากแผนรวมก่อนเปลี่ยนเป็น APPROVED",
        security: "cookie",
        parameters: [pathParameter("productionId", "Lark PC_Production record_id", "recxxxxxxxx")],
        requestSchema: "PcProductionActionRequest",
        responseSchema: "PcProductionRecord",
    },
    {
        path: "/pc/production/{productionId}/start",
        method: "post",
        tag: "Production & Stock",
        summary: "เริ่ม Production batch",
        description: "เปลี่ยน batch ที่อนุมัติแล้วเป็น IN_PROGRESS โดยไม่หักวัตถุดิบ",
        security: "cookie",
        parameters: [pathParameter("productionId", "Lark PC_Production record_id", "recxxxxxxxx")],
        requestSchema: "PcProductionActionRequest",
        responseSchema: "PcProductionRecord",
    ...
    {
        path: "/pc/production/{productionId}/cancel",
        method: "post",
        tag: "Production & Stock",
        summary: "ยกเลิก Production batch",
        description: "ยกเลิก batch ที่ยังไม่ Post stock และคำนวณแผนวัตถุดิบใหม่",
        security: "cookie",
        parameters: [pathParameter("productionId", "Lark PC_Production record_id", "recxxxxxxxx")],
        requestSchema: "PcProductionActionRequest",
        responseSchema: "PcProductionRecord",
    ...
    {
        path: "/pc/production/{productionId}/complete",
        method: "post",
        tag: "Production & Stock",
        summary: "ส่ง Production completion เข้าคิว",
        description: "หักวัตถุดิบและเพิ่ม Finished Goods เฉพาะตอน Queue ปิดงานสำเร็จ ต้องมี Idempotency-Key",
        security: "cookie",
        parameters: [
            pathParameter("productionId", "Lark PC_Production record_id", "recxxxxxxxx"),
            header("Idempotency-Key", "คีย์บังคับสำหรับป้องกัน Post stock ซ้ำ", true),
        ],
        requestSchema: "PcProductionCompleteRequest",
        requestExample: { actual_qty: 20, owner: "Production Team" },
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    },
    ...
    {
        path: "/webhooks/lark/pc/order-sync",
        method: "post",
        tag: "Production & Stock",
        summary: "รับคำสั่ง Reconcile Order จาก Lark Workflow",
        description: "ตรวจ LARK_WORKFLOW_TOKEN แล้วส่ง Order เข้า Queue แบบ Async",
        security: "workflow",
        parameters: [header("Idempotency-Key", "คีย์เหตุการณ์จาก Workflow", false)],
        requestSchema: "OrderRecordRequest",
        requestExample: { order_record_id: "recxxxxxxxx" },
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    ...
    {
        path: "/webhooks/lark/pc/material-refresh",
        method: "post",
        tag: "Production & Stock",
        summary: "รับคำสั่ง Refresh วัตถุดิบจาก Lark Workflow",
        description: "ตรวจ LARK_WORKFLOW_TOKEN แล้วส่งงานคำนวณ Material plan เข้า Queue",
        security: "workflow",
        parameters: [header("Idempotency-Key", "คีย์เหตุการณ์จาก Workflow", false)],
        requestSchema: "PcWorkflowRequest",
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    },
    {
        path: "/webhooks/lark/pc/production-complete",
        method: "post",
        tag: "Production & Stock",
        summary: "รับ Production completion จาก Lark Workflow",
        description: "ส่งงานหักวัตถุดิบและเพิ่ม Finished Goods เข้า Queue โดยใช้ production_record_id และ actual_qty",
        security: "workflow",
        parameters: [header("Idempotency-Key", "คีย์ป้องกัน Post stock ซ้ำ", false)],
        requestSchema: "PcProductionCompleteWorkflowRequest",
        requestExample: {
            production_record_id: "recxxxxxxxx",
            actual_qty: 20,
            idempotency_key: "production-complete-001",
        },
        responseSchema: "PcQueuedResponse",
        successStatus: 202,
    },
    ...
    },
    {
        ...
        method: "get",
        tag: "Documents",
        summary: "รายการเอกสารสำหรับ Dashboard",
    ...
    },
    {
        ...
        method: "get",
        tag: "Documents",
        summary: "รายละเอียดและ Preview เอกสาร",
        description: "สร้าง signed preview ชั่วคราวและคืน Document View Model จาก service เดิมโดยไม่บันทึกเลขเอกสารซ้ำ",
        security: "cookie",
        parameters: [
            pathParameter("orderId", "Lark Order record_id", "recxxxxxxxx"),
            { ...pathParameter("documentType", "ชนิดเอกสาร"), schema: { type: "string", enum: ["quotation", "invoice", "tax-invoice"] } },
        ],
        responseSchema: "DashboardDocumentDetailResponse",
    },
    {
        path: "/dashboard/documents/preview",
        method: "post",
        tag: "Documents",
        summary: "Preview เอกสารก่อนสร้าง",
        description: "ตรวจข้อมูล Order/Customer/Tax แล้วคืน View Model และ signed preview โดยยังไม่บันทึกลิงก์ลง Order",
        security: "cookie",
        requestSchema: "DashboardDocumentRequest",
        requestExample: { order_id: "recxxxxxxxx", document_type: "quotation" },
        responseSchema: "DashboardDocumentDetailResponse",
    },
    {
        path: "/dashboard/documents",
        method: "post",
        tag: "Documents",
        summary: "สร้างเอกสารจาก Order",
        description: "Admin/Manager สร้าง signed document link ผ่าน service เดิม พร้อม idempotency, Activity audit และ cache invalidation",
        security: "cookie",
        parameters: [header("Idempotency-Key", "คีย์ป้องกันเลขเอกสารและ Activity ซ้ำ", false)],
        requestSchema: "DashboardDocumentCreateRequest",
        requestExample: { order_id: "recxxxxxxxx", document_type: "invoice", idempotency_key: "document-create-request-001" },
        responseSchema: "DashboardDocumentCreateResponse",
        successStatus: 201,
    },
    {
    ...
    return {
        ...
        HealthResponse: {
            ...
            properties: {
                ...
                version: { type: "string", example: "pc-stock-production-flag-guard-th-48" },
            ...
            properties: {
                ...
                action_counts: {
                    ...
                    properties: {
                        ...
                        hot_leads: { type: "integer", minimum: 0 },
                        marketplace_ready_to_ship: { type: "integer", minimum: 0 },
        ...
        OrderRecordResponse: {
            ...
            properties: {
                ...
                payment_display_status: { type: "string", enum: ["unpaid", "payment_review", "paid", "overdue"] },
                address: { type: ["string", "null"] },
                tracking_number: { type: ["string", "null"] },
                payment_verified: { type: "boolean" },
                payment_review_available: { type: "boolean" },
                work_queue: { type: "string", enum: ["payment_review", "waiting_new_slip", "waiting_payment", "missing_delivery", "ready_to_ship", "marketplace_ready_to_ship", "none"] },
                missing_delivery_fields: { type: "array", items: { type: "string", enum: ["name", "phone", "address"] } },
                amount_edit_allowed: { type: "boolean" },
                amount_edit_block_reason: { type: ["string", "null"], enum: ["marketplace_order", "paid_or_verified", "payment_review_pending", "inactive_order", "financial_transaction_completed", null] },
        ...
        OrderAmountUpdateRequest: {
            type: "object",
            required: ["total_amount", "expected_updated_at"],
            properties: {
                total_amount: { type: ["string", "number"], description: "จำนวน THB มากกว่า 0 ทศนิยมไม่เกิน 2 ตำแหน่ง" },
                expected_updated_at: { type: "string", format: "date-time" },
                idempotency_key: { type: "string", minLength: 8, maxLength: 120 },
                reason: { type: "string", maxLength: 500 },
            },
        },
        OrderAmountUpdateResponse: {
            type: "object",
            required: ["order", "idempotent", "changed"],
            properties: {
                order: { $ref: "#/components/schemas/OrderRecordResponse" },
                idempotent: { type: "boolean" },
                changed: { type: "boolean" },
            },
        },
        DashboardDocumentRequest: {
            type: "object",
            required: ["order_id", "document_type"],
            properties: {
                order_id: { type: "string" },
                document_type: { type: "string", enum: ["quotation", "invoice", "tax-invoice"] },
            },
        },
        DashboardDocumentCreateRequest: {
            allOf: [
                { $ref: "#/components/schemas/DashboardDocumentRequest" },
                { type: "object", properties: { idempotency_key: { type: "string", minLength: 8, maxLength: 120 } } },
            ],
        },
        ...
        DashboardDocumentListResponse: {
            type: "object",
            required: ["items", "total", "page", "page_size", "total_pages", "updated_at"],
            properties: {
                items: { type: "array", items: { $ref: "#/components/schemas/DashboardDocumentListItemResponse" } },
                total: { type: "integer", minimum: 0 },
                page: { type: "integer", minimum: 1 },
                page_size: { type: "integer", minimum: 1, maximum: 100 },
                total_pages: { type: "integer", minimum: 1 },
        ...
        DashboardDocumentDetailResponse: {
            allOf: [
                { $ref: "#/components/schemas/DashboardDocumentListItemResponse" },
                {
                    type: "object",
        ...
        DashboardDocumentCreateResponse: {
            type: "object",
        ...
        PcQueuedResponse: {
            ...
            properties: {
                ...
                order_record_id: { type: "string" },
                production_record_id: { type: "string" },
        ...
        PcProductRecord: {
            ...
            properties: {
                ...
                sku: { type: "string", example: "BNK-LUNA-IV-M" },
                ...
                sales_price_thb: { type: "number", minimum: 0 },
                stock_on_hand: { type: "number" },
                min_stock: { type: "number", minimum: 0 },
                target_stock: { type: "number", minimum: 0 },
                stock_status: {
                    type: "string",
                    enum: ["NORMAL", "LOW_STOCK", "OUT_OF_STOCK"],
                },
                recommended_production_qty: { type: "number", minimum: 0 },
                production_lead_days: { type: "number", minimum: 0 },
        ...
        PcMaterialRecord: {
            ...
            properties: {
                ...
                min_stock: { type: "number", minimum: 0 },
                target_stock: { type: "number", minimum: 0 },
                planned_requirement: { type: "number", minimum: 0 },
                projected_stock: { type: "number" },
                shortage_qty: { type: "number", minimum: 0 },
                material_status: {
                    type: "string",
                    enum: [
                        "NORMAL",
                ...
                recommended_reorder_qty: { type: "number", minimum: 0 },
                alert_level: {
                    type: "string",
        ...
        PcProductionRecord: {
            ...
            properties: {
                ...
                reason: {
                    type: "string",
                    enum: ["ORDER_SHORTAGE", "MIN_STOCK", "MANUAL"],
                },
                order_shortage_qty: { type: "number", minimum: 0 },
                recommended_qty: { type: "number", minimum: 0 },
                planned_qty: { type: "number", minimum: 0 },
                actual_qty: { type: "number", minimum: 0 },
                material_check_status: {
                    type: "string",
                    enum: ["SUFFICIENT", "INSUFFICIENT", "BOM_MISSING"],
                },
                production_status: {
                    type: "string",
                    enum: [
                ...
                material_requirement_summary: { type: "string" },
                material_risk_summary: { type: "string" },
                due_date: { type: "integer", description: "Unix milliseconds" },
                inventory_posted: { type: "boolean" },
                created_at: { type: "integer", description: "Unix milliseconds" },
                completed_at: { type: "integer", description: "Unix milliseconds" },
                owner: { type: "string" },
                notes: { type: "string" },
            },
        },
        PcOverviewResponse: {
            type: "object",
            required: ["summary", "products", "materials", "production"],
            properties: {
                summary: {
                    type: "object",
                ...
                products: {
                    type: "array",
                    items: { $ref: "#/components/schemas/PcProductRecord" },
                },
                materials: {
                    type: "array",
                    items: { $ref: "#/components/schemas/PcMaterialRecord" },
                },
                production: {
                    type: "array",
                    items: { $ref: "#/components/schemas/PcProductionRecord" },
                },
            },
        },
        PcOrderBulkReconcileRequest: {
            type: "object",
            required: ["confirm_selected_orders", "order_record_ids"],
            properties: {
                confirm_selected_orders: { type: "boolean", const: true },
                order_record_ids: {
                    type: "array",
                    minItems: 1,
                    maxItems: 100,
        ...
        PcProductionCreateRequest: {
            type: "object",
            required: ["product_sku", "planned_qty"],
            properties: {
                product_sku: { type: "string", minLength: 1 },
                planned_qty: { type: "number", exclusiveMinimum: 0 },
                owner: { type: "string" },
                notes: { type: "string" },
            },
        },
        PcProductionActionRequest: {
            type: "object",
            properties: {
                planned_qty: { type: "number", exclusiveMinimum: 0 },
                owner: { type: "string" },
        ...
        PcProductionCompleteRequest: {
            type: "object",
            required: ["actual_qty"],
            properties: {
                actual_qty: { type: "number", exclusiveMinimum: 0 },
        ...
        PcProductionCompleteWorkflowRequest: {
            type: "object",
            required: ["production_record_id", "actual_qty"],
            properties: {
                production_record_id: { type: "string" },
                actual_qty: { type: "number", exclusiveMinimum: 0 },
                idempotency_key: { type: "string" },
...
export function buildOpenApiDocument(request: Request): Record<string, unknown> {
    ...
    return {
        ...
        tags: [
            ...
            { name: "Production & Stock", description: "Finished Goods, Material planning และ Production lifecycle" },
