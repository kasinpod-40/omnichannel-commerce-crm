...
export const API_ROUTE_DEFINITIONS: RouteDefinition[] = [
    ...
    },
    {
        ...
        method: "get",
        tag: "Notifications",
        summary: "รายการแจ้งเตือนสำหรับ Notification Center",
        description: "อ่าน Notifications จาก Lark Base พร้อมตัวกรอง สถานะอ่าน Pagination และ Order deep link",
        security: "cookie",
        parameters: [
            query("search", "ค้นหาจากข้อความ ลูกค้า Order ID หรือ Event ID"),
            query("type", "กรองประเภท Notification", { type: "string", enum: ["NEW_LEAD", "HOT_LEAD", "PAYMENT_REVIEW", "PAYMENT_VERIFIED", "SALE_WON", "SALE_LOST", "PAYMENT_OVERDUE"] }),
    ...
    },
    {
        ...
        description: "อ่าน dashboard read marker โดยไม่เปลี่ยนสถานะการส่งเข้า Lark Group",
        security: "cookie",
    ...
    },
    {
        ...
        method: "post",
        tag: "Notifications",
        summary: "ทำเครื่องหมาย Notification ทั้งหมดว่าอ่านแล้ว",
        description: "บันทึก read marker ใน payload_json เดิม โดยไม่ขัดขวาง Queue ที่ยังต้องส่ง Lark Group",
        security: "cookie",
    ...
    },
    {
        ...
        method: "post",
        tag: "Notifications",
        summary: "ทำเครื่องหมาย Notification หนึ่งรายการว่าอ่านแล้ว",
        description: "บันทึก read marker สำหรับ Notification Center โดยรักษา delivery status เดิม",
        security: "cookie",
    ...
    return {
        ...
        HealthResponse: {
            ...
            properties: {
                ...
                version: { type: "string", example: "notification-channel-normalization-th-31" },
        ...
        NotificationRecordResponse: {
            ...
            properties: {
                ...
                notification_type: { type: "string", enum: ["NEW_LEAD", "HOT_LEAD", "PAYMENT_REVIEW", "PAYMENT_VERIFIED", "SALE_WON", "SALE_LOST", "PAYMENT_OVERDUE"] },
