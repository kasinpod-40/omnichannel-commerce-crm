...
- ห้ามสร้างหรือเดาชื่อสินค้า จำนวน หน่วยสินค้า ธนาคาร ยอดเงิน หรือที่อยู่ที่ไม่มีอยู่ในข้อความ
...
- product_name, product_unit และ address ให้คงชื่อแบรนด์ รุ่น รหัสสินค้า ตัวเลข หรือคำภาษาอังกฤษที่ลูกค้าพิมพ์มาจริง ห้ามแปลหรือเปลี่ยนความหมายเอง
