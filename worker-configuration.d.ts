/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77c5dffcf0840186a699ed512dd17876)
...
interface __BaseEnv_Env {
	...
	WORKERS_TEXT_MODEL: "@cf/zai-org/glm-4.7-flash";
	GEMINI_TEXT_MODEL: "gemini-2.5-flash";
	GEMINI_IMAGE_MODEL: "gemini-2.5-flash";
	PAYMENT_DUE_HOURS: "24";
	PC_INVENTORY_ENABLED: "false";
	DASHBOARD_URL: "https://omnichannel-commerce-crm-dashboard.pages.dev";
	LARK_AUTH_REDIRECT_URI: "https://omnichannel-commerce-crm.kasinpod40.workers.dev/auth/lark/callback";
	AUTH_ALLOWED_ORIGINS: "https://omnichannel-commerce-crm-dashboard.pages.dev,http://localhost:5173";
	...
	TIKTOK_REDIRECT_URI: "https://omnichannel-commerce-crm.kasinpod40.workers.dev/oauth/tiktok/callback";
	LAZADA_API_BASE: "https://api.lazada.co.th/rest";
	LAZADA_AUTH_BASE: "https://auth.lazada.com";
	LAZADA_REDIRECT_URI: "https://omnichannel-commerce-crm.kasinpod40.workers.dev/oauth/lazada/callback";
	LAZADA_POLL_ENABLED: "false";
	LAZADA_POLL_INITIAL_LOOKBACK_MINUTES: "1440";
	LAZADA_POLL_OVERLAP_MINUTES: "10";
	LAZADA_POLL_PAGE_SIZE: "100";
	LAZADA_POLL_MAX_PAGES: "5";
	DOCUMENT_COMPANY_NAME: "บริษัท ตัวอย่าง จำกัด";
	DOCUMENT_COMPANY_ADDRESS: "99/99 ถนนสุขุมวิท แขวงคลองตันเหนือ เขตวัฒนา กรุงเทพมหานคร 10110";
	DOCUMENT_COMPANY_TAX_ID: "0105559999999";
	DOCUMENT_COMPANY_BRANCH: "สำนักงานใหญ่";
	DOCUMENT_COMPANY_PHONE: "02-000-0000";
	DOCUMENT_COMPANY_EMAIL: "contact@example.co.th";
	DOCUMENT_VAT_RATE: "7";
	DOCUMENT_PRICE_INCLUDES_VAT: "true";
	DOCUMENT_COMPANY_PRIMARY_COLOR: "#15865A";
	DOCUMENT_COMPANY_ACCENT_COLOR: "#E8FAF2";
	DOCUMENT_TAX_FORM_EXPIRES_MINUTES: "10080";
	ENVIRONMENT: string;
	LARK_APP_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_TEST_ROUTES" | "WORKERS_TEXT_MODEL" | "GEMINI_TEXT_MODEL" | "GEMINI_IMAGE_MODEL" | "PAYMENT_DUE_HOURS" | "PC_INVENTORY_ENABLED" | "DASHBOARD_URL" | "LARK_AUTH_REDIRECT_URI" | "AUTH_ALLOWED_ORIGINS" | "AUTH_SESSION_TTL_SECONDS" | "AUTH_COOKIE_SAME_SITE" | "LARK_GROUP_WEBHOOK_KEYWORD" | "TIKTOK_API_BASE" | "TIKTOK_AUTH_BASE" | "TIKTOK_REDIRECT_URI" | "LAZADA_API_BASE" | "LAZADA_AUTH_BASE" | "LAZADA_REDIRECT_URI" | "LAZADA_POLL_ENABLED" | "LAZADA_POLL_INITIAL_LOOKBACK_MINUTES" | "LAZADA_POLL_OVERLAP_MINUTES" | "LAZADA_POLL_PAGE_SIZE" | "LAZADA_POLL_MAX_PAGES" | "DOCUMENT_COMPANY_NAME" | "DOCUMENT_COMPANY_ADDRESS" | "DOCUMENT_COMPANY_TAX_ID" | "DOCUMENT_COMPANY_BRANCH" | "DOCUMENT_COMPANY_PHONE" | "DOCUMENT_COMPANY_EMAIL" | "DOCUMENT_VAT_RATE" | "DOCUMENT_PRICE_INCLUDES_VAT" | "DOCUMENT_COMPANY_PRIMARY_COLOR" | "DOCUMENT_COMPANY_ACCENT_COLOR" | "DOCUMENT_TAX_FORM_EXPIRES_MINUTES" | "ENVIRONMENT" | "LARK_APP_ID" | "LARK_APP_SECRET" | "LARK_APP_TOKEN" | "CUSTOMERS_TABLE_ID" | "CONVERSATIONS_TABLE_ID" | "PIPELINE_TABLE_ID" | "ORDERS_TABLE_ID" | "ACTIVITIES_TABLE_ID" | "NOTIFICATIONS_TABLE_ID" | "LARK_GROUP_WEBHOOK_URL" | "NOTIFICATION_DISPATCH_TOKEN" | "PC_BASE_APP_TOKEN" | "PC_PRODUCTS_TABLE_ID" | "PC_MATERIALS_TABLE_ID" | "PC_PRODUCTION_TABLE_ID">> {}
}
